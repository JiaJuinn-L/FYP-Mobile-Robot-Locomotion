...
from dijkstra_core import dijkstra
import math
...
def move_forward(target, speed=5, tol=0.2, slow_down_radius=0.5):
    tx, ty = target
...
def _rotate_by(delta_deg, speed_rad=1.0, tol_deg=0.5):
...
# … up in your loop 
while current != goal:
    path, nodes_expanded = dijkstra(grid, current, goal)
